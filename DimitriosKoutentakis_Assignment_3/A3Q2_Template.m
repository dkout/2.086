multiple_choice_selection = {'e','a','b','?'};
...
% For example: if your choices are "z" for each part, then you should set
%      muliple_choice_selection = {'z','z','z','z'};
% Note you must use the single-quote marks around each letter
% Do NOT include spaces within the quotes
